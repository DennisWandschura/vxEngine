...
namespace Editor
{
	...
	public:
		...
		void drawMouse(const ShaderManager &shaderManager, vx::gl::StateManager* pStateManager) const;
		void drawWaypoints(const ShaderManager &shaderManager, vx::gl::StateManager* pStateManager) const;
